...
class Levels: NSObject {
    ...
    static let a3 = Level(levelId: 3, numberOfLinesProvided: 2, numberOfTrianglesRequired: 4, lines:
    ...
    static let a4 = Level(levelId: 3, numberOfLinesProvided: 3, numberOfTrianglesRequired: 6, lines:
    ...
    static let b0 = Level(levelId: 3, numberOfLinesProvided: 1, numberOfTrianglesRequired: 0, lines:
    ...
    static let a5 = Level(levelId: 4, numberOfLinesProvided: 2, numberOfTrianglesRequired: 8, lines:
    ...
    static let a6 = Level(levelId: 5, numberOfLinesProvided: 2, numberOfTrianglesRequired: 10, lines:
    ...
    static let b1 = Level(levelId: 5, numberOfLinesProvided: 2, numberOfTrianglesRequired: 4, lines:
        [Line(id: -1, start: CGPoint(x: 62.5, y: 331.0), end: CGPoint(x: 327.5, y: 153.0)),
         Line(id: -1, start: CGPoint(x: 103.5, y: 273.5), end: CGPoint(x: 282.5, y: 534.0)),
         Line(id: -1, start: CGPoint(x: 115.0, y: 382.5), end: CGPoint(x: 327.5, y: 153.0))])
    
    static let a7 = Level(levelId: 6, numberOfLinesProvided: 3, numberOfTrianglesRequired: 9, lines:
    ...
    static let a8 = Level(levelId: 7, numberOfLinesProvided: 3, numberOfTrianglesRequired: 7, lines:
    ...
    static let a9 = Level(levelId: 8, numberOfLinesProvided: 3, numberOfTrianglesRequired: 11, lines:
    ...
    static let a10 = Level(levelId: 9, numberOfLinesProvided: 2, numberOfTrianglesRequired: 3, lines:
